        ...
        for watchlist_type, watchlist_dict in watchlists_list:
            ...
            for watchlist_name, watchlist_sub_dict in watchlist_dict.items():
                for ticker_dict in watchlist_sub_dict['tickers']:
                    ...
                    try:
                        strategy_obj = Strategy(ticker_dict['ticker_yahoo'], ticker_dict['order_book_id'], self.ava)
                    except Exception as e:
                        log.error(f'(!) There was a problem with the ticker "{ticker_dict["ticker_yahoo"]}": {e}')
                        continue
